...
class AnalysisScreen extends StatelessWidget {
  ...
  builder: (context, state) {
    return Column(
          children: [
            Text('analysis_title'.tr(context),  style: interRegular.copyWith(
              color: AppColors.forthColor,
              fontSize: SizeConfig.responsiveValue(phone: 14.sp, tablet: 18.sp),
            ),),
            const Divider(),
            Text('figure1'.tr(context),  style: interRegular.copyWith(
            ...
            PerformanceChart(data: context.read<AnalysisCubit>().analysisModel!.data!,)
          ],
        );
  },
),
