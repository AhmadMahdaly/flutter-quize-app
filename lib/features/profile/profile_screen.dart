  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MainLayoutCubit, MainLayoutState>(
      builder: (context, state) {
        return context.read<MainLayoutCubit>().profileModel==null?Scaffold(
            appBar: const ProfileAppBarWidgets(
              canBack: false,
              imagePath: 'https://upload.wikimedia.org/wikipedia/commons/9/99/Sample_User_Icon.png'

            ),
        body: Column(
          children: [
            Center(child: CircularProgressIndicator(color: AppColors.primaryColor,strokeWidth: 10.w,))
          ],
        ),
        ):Scaffold(
