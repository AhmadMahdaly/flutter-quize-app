  ...
  Widget build(BuildContext context) {
    ...
    margin: EdgeInsets.only(bottom: 10.h),
      decoration: BoxDecoration(
        color: isSelected==true&&isTrue==false?AppColors.errorColor:context
            .read<QBankcubit>()
            .qBankModel!
            .data![context.read<QBankcubit>().index]
            .selectedAnswer!=null&&isTrue?AppColors.successColor: AppColors.primaryColor,
...
class AnsweredWidget extends StatelessWidget {
  const AnsweredWidget({super.key, required this.answerText, required this.isTrue});
  final String answerText;
  final bool isTrue;
  @override
  Widget build(BuildContext context) {
