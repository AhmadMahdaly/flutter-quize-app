...
class QBankProgressWidget extends StatelessWidget {
  const QBankProgressWidget(
      {super.key, required this.currentValue, required this.endValue, required this.switchValue, this.switchFun});
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          50.horizontalSpace,
          Icon(CupertinoIcons.book,color: AppColors.secondaryColor,size: 30.r,),
          20.horizontalSpace,
          Transform.scale(
            scale: 1.2,
